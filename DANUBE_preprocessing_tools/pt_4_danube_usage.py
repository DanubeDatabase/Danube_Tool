...
from pt_density_pop import dens_pop
...
def usage_from_topo(bati, activ):
    ...
    print(relation_activ_usage.columns)
    print(relation_activ_usage.head())
    ...
    print(relation_bati_usage.columns)
    print(relation_bati_usage.head())

    #___________________Deep copy of the layer, to avoid modifying the data source___________________
...
def main_4():
    print("#" * 60)
    print("Run main 4 : Usage definition")
    print("#" * 60)
