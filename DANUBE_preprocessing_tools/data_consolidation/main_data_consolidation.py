from dev_set_test import print_d, print_memory_use, timed_execution_d, add_layer_gui
...
def main_dc_data_consolidation(DANUBE_LAYERS):
    ...
    DANUBE_LAYERS = timed_execution_d(main_dc_1, DANUBE_LAYERS)
    ...
    DANUBE_LAYERS = timed_execution_d(main_dc_3,DANUBE_LAYERS)
    print_memory_use()

    # ____________________________________________________________________________________________________________

    # step 4 - join attributes from TOPO_ACTIVITE
    DANUBE_LAYERS =  timed_execution_d(main_topo_activ,DANUBE_LAYERS)
    print_memory_use()
    ...
    DANUBE_LAYERS =  timed_execution_d(add_filo_dens_pop,DANUBE_LAYERS)
    print_memory_use()
